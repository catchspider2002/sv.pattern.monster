const strings = {
  ...
  description:
    "En smidig online-mönstergenerator för att skapa mönsterpassade SVG-mönster.",
  description2: "Snabba upp din webbplats utan att kompromissa med bildkvalitet.",
  description3: 
    "Perfekt för webbplatsens bakgrunder, kläder, varumärke, förpackningsdesign och mer.",
  keywords:
    "svg mönster, mönster, svg bakgrunder, vektor bakgrundsbild, mönstergenerator, mönsterskapare",
  pages: [
    {
      page: "index",
